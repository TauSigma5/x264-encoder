...
namespace IOPlugin
{
    ...
    {
        clrUnknown = 0,
        clrRGB, // interleaved RGB
        clrRGBp, // planar RGB
        clrRGBA, // interleaved RGBA
        clrRGBAp, // planar RGBA
        clrV210, // packed v210 YUV 10 bit
        clrR210, // packed r210
        clrYUVp, // planar YUV, must be set along with hSubsampling and vSubsampling properties
        clrUYVY, // interleaved 422 YUV
        clrNV12, // Y plane with interleaved U + V plane
    };
